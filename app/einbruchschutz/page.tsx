...
export const metadata = generateSharedMetadata({
  title: "Einbruchschutz & Sicherheitsberatung Limburg | Fachbetrieb",
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start">
                 ...
                 <div className="max-w-xl">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[var(--color-text-main)] leading-[1.1] tracking-tight mb-6 text-balance">
                       Schützen Sie, <br/>was Ihnen <span className="text-[var(--color-blue-primary)]">am wichtigsten ist.</span>
                    </h1>
                    <p className="text-lg text-[var(--color-text-body)] font-medium mb-8 text-balance leading-relaxed">
                       Ein Einbruch hinterlässt nicht nur finanzielle, sondern tiefe psychologische Spuren. Überlassen Sie den Schutz Ihrer Familie nicht dem Zufall. Als regionaler Meisterbetrieb aus Limburg-Weilburg rüsten wir Ihr Zuhause mit zertifizierter Sicherheitstechnik nach – diskret, hochwirksam und absolut verlässlich.
                    </p>
                    
                    <div className="bg-[var(--color-surface-elevated)] border border-[var(--color-border-subtle)] rounded-3xl p-8 mb-8 shadow-sm">
                       <h3 className="font-bold text-2xl text-[var(--color-text-main)] mb-5 flex items-center gap-3">
                         <AlertTriangle className="h-6 w-6 text-amber-500" />
                         Prävention rettet Werte
                       </h3>
                       <p className="text-[var(--color-text-body)] mb-6">
                         Polizeistatistiken belegen: Sichtbarer und fachgerecht montierter Einbruchschutz lässt über 80% aller Einbruchsversuche scheitern. Täter suchen den schnellen, geräuschlosen Einstieg.
                       </p>
                       <ul className="space-y-4">
                          {[
                             "Kostenfreie & diskrete Schwachstellenanalyse in Limburg",
                             "VdS-zertifizierte Nachrüstung von Türen und Fenstern",
                             "Montage ausschließlich durch eigene, geschulte Monteure",
                             "100% Transparenz: Verbindliche Festpreise für Ihr Upgrade"
                          ].map((item, i) => (
                    ...
                    <div className="grid grid-cols-2 gap-5">
                       <div className="bg-[var(--color-blue-dark)] border border-[var(--color-border-subtle)] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                          ...
                          <h4 className="font-bold text-[var(--color-text-main)]">Mechanik</h4>
                          <p className="text-sm text-[var(--color-text-body)] mt-2">Panzerriegel, Zusatzschlösser & einbruchhemmende Pilzkopfzapfen.</p>
                       </div>
                       <div className="bg-[var(--color-blue-dark)] border border-[var(--color-border-subtle)] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                          <Eye className="h-8 w-8 text-[var(--color-blue-primary)] mb-3" />
                          <h4 className="font-bold text-[var(--color-text-main)]">Elektronik</h4>
                          <p className="text-sm text-[var(--color-text-body)] mt-2">Smarte Alarmanlagen und Videoüberwachung zur präventiven Abschreckung.</p>
                       </div>
                    </div>
                 </div>
                 ...
                 <div className="w-full lg:sticky lg:top-32 mt-8 lg:mt-0">
                    <div className="bg-[var(--color-blue-dark)] shadow-2xl shadow-[var(--color-brand-light)]/20 border border-[var(--color-border-subtle)] rounded-3xl p-6 md:p-10 relative overflow-hidden">
                       ...
                       <div className="mb-8">
                         <h3 className="text-2xl font-bold text-[var(--color-text-main)] mb-2">Kostenlose Sicherheitsanalyse</h3>
