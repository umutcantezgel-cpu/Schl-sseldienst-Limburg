        ...
        <div className="mt-[var(--space-8)] flex flex-col items-center w-full px-[var(--space-4)] sm:px-0 z-10">
            <div className="flex flex-col sm:flex-row items-center gap-[var(--space-4)] w-full max-w-md mx-auto">
                <a
                    ...
                    className="flex w-full items-center justify-center gap-[var(--space-3)] bg-[var(--color-emergency)] text-[var(--color-text-inverted)] hover:bg-[var(--color-emergency-hover)] active:scale-[0.98] transition-all rounded-full py-[var(--space-4)] px-[var(--space-6)] shadow-lg"
                >
            ...
            <div className="mt-[var(--space-6)] flex items-center justify-center gap-[var(--space-2)] rounded-full bg-[var(--color-success-bg)] px-[var(--space-4)] py-[var(--space-2)] border border-[#A7F3D0]">
                <span className="relative flex h-2.5 w-2.5">
                    <span className="absolute inline-flex h-full w-full rounded-full opacity-75 bg-[var(--color-success)]"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[var(--color-success)]"></span>
                </span>
                <span className="text-[12px] font-[700] text-[#047857]">
