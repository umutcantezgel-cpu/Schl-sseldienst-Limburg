...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "rounded-[var(--radius-lg)] border border-[var(--color-border-subtle)] bg-white text-[var(--color-text-primary)] shadow-sm transition-all duration-[var(--duration-normal)]",
            className
        )}
        {...props}
    />
